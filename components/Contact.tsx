    ...
    <section className="relative w-full max-w-5xl mx-auto py-12 px-6 mb-12 overflow-visible">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="md:col-span-3 lg:col-span-4 h-full">
          <Link href="mailto:rahtuanom@gmail.com" className="group flex flex-col justify-between h-full p-6 rounded-2xl transition-all duration-300 bg-white border-2 border-slate-900 shadow-[4px_4px_0_0_#0f172a] hover:shadow-[6px_6px_0_0_#ea4335] hover:border-red-500 hover:-translate-y-1 dark:bg-black/40 dark:backdrop-blur-xl dark:border-white/10 dark:shadow-md dark:hover:shadow-xl dark:hover:border-red-500/50">
        ...
        <motion.div variants={itemVariants} className="md:col-span-3 lg:col-span-2 h-full">
          <Link href="https://wa.me/6281234567890" target="_blank" className="group flex flex-col justify-between h-full p-6 rounded-2xl transition-all duration-300 bg-white border-2 border-slate-900 shadow-[4px_4px_0_0_#0f172a] hover:shadow-[6px_6px_0_0_#25D366] hover:border-[#25D366] hover:-translate-y-1 dark:bg-black/40 dark:backdrop-blur-xl dark:border-white/10 dark:shadow-md dark:hover:shadow-xl dark:hover:border-[#25D366]/50">
        ...
        <motion.div variants={itemVariants} className="md:col-span-2 h-full">
          <Link href="https://linkedin.com" target="_blank" className="group flex flex-col justify-between h-full p-6 rounded-2xl transition-all duration-300 bg-white border-2 border-slate-900 shadow-[4px_4px_0_0_#0f172a] hover:shadow-[6px_6px_0_0_#0A66C2] hover:border-[#0A66C2] hover:-translate-y-1 dark:bg-black/40 dark:backdrop-blur-xl dark:border-white/10 dark:shadow-md dark:hover:shadow-xl dark:hover:border-[#0A66C2]/50">
        ...
        {/* GitHub Card */}
        <motion.div variants={itemVariants} className="md:col-span-2 h-full">
          <Link href="https://github.com" target="_blank" className="group flex flex-col justify-between h-full p-6 rounded-2xl transition-all duration-300 bg-slate-900 border-2 border-slate-900 text-white shadow-[4px_4px_0_0_#0f172a] hover:shadow-[6px_6px_0_0_#333] hover:-translate-y-1 dark:bg-slate-900 dark:backdrop-blur-xl dark:border-white/10 dark:shadow-md dark:hover:shadow-xl dark:hover:border-slate-500">
        ...
        {/* Instagram Card */}
        <motion.div variants={itemVariants} className="md:col-span-2 h-full">
          <Link href="https://instagram.com" target="_blank" className="group flex flex-col justify-between h-full p-6 rounded-2xl transition-all duration-300 bg-white border-2 border-slate-900 shadow-[4px_4px_0_0_#0f172a] hover:shadow-[6px_6px_0_0_#E1306C] hover:border-[#E1306C] hover:-translate-y-1 dark:bg-black/40 dark:backdrop-blur-xl dark:border-white/10 dark:shadow-md dark:hover:shadow-xl dark:hover:border-[#E1306C]/50">
